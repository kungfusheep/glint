/**
 * Optimized GlintDecoder using the optimized BinaryReader
 */

import { BinaryReaderOptimized as BinaryReader } from './reader-optimized';
...
export class GlintDecoderOptimized {
